...
const Features = () => {
    return (
        <AnchorSection id='features'>
            <div className='py-24 relative border-y-2 border-black'>
                <svg
                ...
                <div className='container max-w-7xl'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-16'>
                        <SingleFeature
                            ...
                            title={"Ui Ux Design"}
                            text={
                                "I've learned ui ux design from online and created many designs which is shown in my behance and dribbble portfolios. I've used figma for creating those awesome designs."
                            }
                        />
                        <SingleFeature
                            bgColor={"bg-[#F2FFE3]"}
                            title={"Web Design"}
                            text={
                                "I've learned web design from various paltform and various courses. I used HTML, Css, Bootstrap, Tailwind css for converting design to clean code."
                            }
                        />
                        <SingleFeature
                            bgColor={"bg-[#FDE4F9]"}
                            title={"Web App Develop"}
                            text={
                                "I've start my journey in web application development by learning javascript. After that I start working on React and Next js. I've spend lots of time in those techonologies."
                            }
                        />
                        <SingleFeature
                            bgColor={"bg-[#E2F2FF]"}
                            title={"Wordpress (Elementor/Divi)"}
                            text={
                                "Before starting web application development I was worked on fiverr.com for freelaincing. I spacially did wordpress customization, Basic front end support etc."
                            }
                        />
                    </div>
                </div>
